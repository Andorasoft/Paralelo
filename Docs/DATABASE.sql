...
create table if not exists "public"."plan" (
  ...
  "featured_projects_limit" integer not null default 0,
...
create table if not exists "public"."user" (
  ...
  "university_id" uuid not null references "university" ("id") on delete restrict
);
...
create table if not exists "public"."report" (
  ...
  "reported_id" uuid references "user" ("id") on delete
  set
    null,
    "project_id" uuid references "project" ("id") on delete
  set
    null
);
