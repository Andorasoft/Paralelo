...
class _ProposalDetailsPageState extends ConsumerState<ProposalDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (_, snapshot) {
        ...
        return page(userId: userId, proposal: proposal);
      },
    );
  }
  ...
  Widget page({required String userId, required Proposal proposal}) {
    return Scaffold(
      key: scaffoldKey,
      appBar: AppBar(
      ...
      bottomNavigationBar: proposal.providerId != userId
          ? FilledButton(onPressed: () {}, child: Text('Aceptar propuesta'))
                .margin(
                  const EdgeInsets.symmetric(horizontal: 16.0, vertical: 8.0),
                )
                .useSafeArea()
